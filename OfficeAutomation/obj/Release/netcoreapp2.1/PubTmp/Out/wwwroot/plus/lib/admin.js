    ...
    function (e) {
        var $ = layui.jquery,
            ...
            F = {
                    ...
                    e.elemPhone = $(e.elemPhone),
                        ...
                        l.on("click",
                            function () {
                                var i = e.elemPhone,
                                    l = i.val();
                                if (t === e.seconds && !$(this).hasClass(f)) {
                ...
                popupRight: function (e) {
                    return F.popup.index = layer.open($.extend({
                        type: 1,
                        id: "LAY_adminPopupR",
                        anim: -1,
                        title: !1,
                ...
                closeThisTabs: function () {
                    F.tabsPage.index && $(z).eq(F.tabsPage.index).find(".layui-tab-close").trigger("click")
                }
            },
            P = F.events = {
                flexible: function (e) {
                ...
                refresh: function () {
                    ...
                    // var e = F.tabsBody(F.tabsPage.index).find(".layadmin-iframe");
                ...
                closeOtherTabs: function (e) {
                    ...
                    "all" === e ? ($(z + ":gt(0)").remove(), $(h).find("." + b + ":gt(0)").remove(), $(z).eq(0).trigger("click")) : ($(z).each(function (e, t) {
                        e && e != F.tabsPage.index && ($(t).addClass(i), F.tabsBody(e).addClass(i))
                    }), $("." + i).remove())
                },
        ...
        !function () {
            ...
            e.theme ? F.theme(e.theme) : l.theme && F.initTheme(l.theme.initColorIndex),
                ...
                l.pageTabs || ($("#LAY_app_tabs").addClass(c), u.addClass("layadmin-tabspage-none")),
